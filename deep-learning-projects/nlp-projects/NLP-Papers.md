...
This is a list of 100 important natural language processing (NLP) papers that serious students and researchers working in the field should probably know about and read. This list is compiled by [Masato Hagiwara](http://masatohagiwara.net/). The links to the papers are added by [Competitive-Let-1213
](https://github.com/oysters76) . I welcome any feedback on this list.
